...
OutputDir=.\build\
OutputBaseFilename=devjammer-{#MyAppVersion}-x64
SetupIconFile=..\docs\assets\images\devjammer.ico
Compression=lzma
...
[Files]
Source: "..\bin\x64\Release\devjammer.exe"; DestDir: "{app}"; Flags: ignoreversion
